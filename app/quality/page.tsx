...
export const metadata: Metadata = {
  ...
  description:
    "Learn about our cutting-edge Chinese and German engineering technology for water purification, bottling, and quality control. NAFDAC and SON certified.",
};
        ...
        <div className="container mx-auto px-2">
          <div className="max-w-4xl mx-auto text-center space-y-6">
            ...
            <p className="text-xl text-gray-600">
              Cutting-edge engineering ensures every drop
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20">
              <div className="space-y-6">
                ...
                <p className="text-lg text-gray-600">
                  Our entire water treatment, bottling, and packaging processes
                  employ state-of-the-art Chinese and German professional
                  engineering principles and technology.
                </p>
                <p className="text-lg text-gray-600">
                  We've invested in cutting-edge equipment and systems that
                  represent the pinnacle of water purification and bottling
                  technology, ensuring consistent quality and safety in every
                  bottle.
                </p>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {PURIFICATION_STEPS.map((step) => (
                <Card
                  key={step.step}
                  className="bg-dovvia-800 border-dovvia-700"
                >
                  <CardContent className="p-6 space-y-3">
                    ...
                    <p className="text-sm text-dovvia-200">
                      {step.description}
                    </p>
                  </CardContent>
                </Card>
        ...
        <div className="container mx-auto px-2">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600">
                Rigorous testing and compliance with Nigerian and international
                standards
              </p>
            </div>
              ...
              {[
                ...
                >
                  <CardContent className="p-6 space-y-4">
                    ...
                    <h3 className="font-semibold text-dovvia-900">
                      {item.title}
                    </h3>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center space-y-8">
            ...
            <p className="text-xl text-gray-600">
              Order Dovvia Still today and taste the purity that comes from
