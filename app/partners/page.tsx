    ...
    try {
      ...
      Promise.all([
        fetch(`${supabaseUrl}/functions/v1/send-email-notification`, {
          ...
          body: JSON.stringify({ formType: 'distributor', data }),
        ...
        <div className="container mx-auto px-2">
          <div className="max-w-4xl mx-auto text-center space-y-6">
            ...
            <p className="text-xl text-gray-600">
              Join Nigeria's leading sustainable water brand and build a
        ...
        <div className="container mx-auto px-2">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-lg text-gray-600">
              Build a profitable business while making a positive environmental
              and social impact
            </p>
          </div>
                ...
                <Card className="bg-gradient-to-br from-dovvia-500 to-dovvia-700 text-white">
                  <CardContent className="p-6">
                    ...
                    <p className="text-dovvia-100 mb-4 text-sm">
                      Contact us on WhatsApp for immediate response to your
                    ...
                    <div>
                      ...
                      <Select name="expected_volume">
                        ...
                        <SelectContent>
                          ...
                          <SelectItem value="1000+">1,000+ crates</SelectItem>
                        </SelectContent>
                      </Select>
                    </div>
