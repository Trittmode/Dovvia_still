...
export const metadata: Metadata = {
  ...
  description:
    "Discover Dovvia Still premium glass bottled water in 50cl and 75cl sizes. Earn ₦150 refund per bottle returned. Perfect for home, office, and events.",
};
        ...
        <div className="container mx-auto px-2">
          <div className="max-w-4xl mx-auto text-center space-y-6">
            ...
            <p className="text-xl text-gray-600">
              Experience pure hydration in eco-friendly glass bottles. Available
              in convenient sizes for every occasion.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-2">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-6xl mx-auto">
            {PRODUCTS.map((product) => (
              <Card
                key={product.id}
                className="overflow-hidden hover:shadow-2xl transition-all border-2 border-dovvia-100"
              >
                <CardContent className="p-0">
                  ...
                  <div className="p-8 space-y-6">
                    ...
                    <div>
                      <h2 className="text-2xl font-bold text-dovvia-900 text-center bg-dovvia-100 mb-3">
                        {product.price
                          ? `₦${product.price}`
                          : "Price Unavailable"}
                      </h2>
                    ...
                    <div>
                      <h4 className="font-semibold text-dovvia-900 mb-3">
                        Perfect For:
                      </h4>
              ...
              {[
                {
                  step: "1",
                  title: "Purchase",
                  desc: "Buy your Dovvia Still water",
                },
                {
                  step: "2",
                  title: "Enjoy",
                  desc: "Experience premium purity",
                },
                {
                  step: "3",
                  title: "Return",
                  desc: "Bring back empty bottles",
                },
                {
                  step: "4",
                  title: "Get ₦150",
                  desc: "Receive refund per bottle",
                },
              ].map((item) => (
                <Card
                  key={item.step}
                ...
                >
                  <CardContent className="p-6 space-y-3">
                    ...
                    <h3 className="text-lg font-semibold text-dovvia-900">
                      {item.title}
                    </h3>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-2">
          <div className="max-w-4xl mx-auto text-center space-y-8">
            ...
            <p className="text-xl text-gray-600">
              Contact us for special pricing on bulk orders for events,
